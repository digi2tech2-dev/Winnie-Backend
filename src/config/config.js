...
const localApiUrl = `http://localhost:${process.env.PORT || 5000}`;
...
const config = {
    ...
    google: {
        ...
        callbackUrl: process.env.GOOGLE_CALLBACK_URL ||
            `${localApiUrl}/api/auth/google/callback`,
    },
    ...
    email: {
        ...
        secure: parseBoolean(process.env.SMTP_SECURE, parseInt(process.env.SMTP_PORT || '587', 10) === 465),
        requireTLS: parseBoolean(process.env.SMTP_REQUIRE_TLS, false),
        // Public base URL for account verification links.
        appUrl: process.env.APP_URL || configuredFrontendUrl || localApiUrl,
    },
