...
const USER_ACTIONS = Object.freeze({
    ...
    IDENTITY_VERIFICATION_REQUIRED: 'USER_IDENTITY_VERIFICATION_REQUIRED',
    IDENTITY_VERIFICATION_CLEARED: 'USER_IDENTITY_VERIFICATION_CLEARED',
});
...
const PAYMENT_ACTIONS = Object.freeze({
    ...
    WEBHOOK_RECEIVED: 'PAYMENT_WEBHOOK_RECEIVED',
    WEBHOOK_PROCESSED: 'PAYMENT_WEBHOOK_PROCESSED',
    WEBHOOK_DUPLICATE: 'PAYMENT_WEBHOOK_DUPLICATE',
    WEBHOOK_FAILED: 'PAYMENT_WEBHOOK_FAILED',
    WEBHOOK_UNMATCHED: 'PAYMENT_WEBHOOK_UNMATCHED',
    RECONCILIATION_SYNCED: 'PAYMENT_RECONCILIATION_SYNCED',
    RECONCILIATION_FAILED: 'PAYMENT_RECONCILIATION_FAILED',
...
const ADMIN_ACTIONS = Object.freeze({
    ...
    USER_RESTORED: 'ADMIN_RESTORED_USER',
    USER_BLOCKED: 'ADMIN_BLOCKED_USER',
    USER_UNBLOCKED: 'ADMIN_UNBLOCKED_USER',
    USER_CURRENCY_CONVERTED: 'ADMIN_CURRENCY_CONVERSION',
    USER_ROLE_CHANGED: 'ADMIN_USER_ROLE_CHANGED',
    USER_PASSWORD_RESET: 'ADMIN_CHANGED_USER_PASSWORD',
