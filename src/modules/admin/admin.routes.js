...
router.get('/providers/fazercards/catalog/families', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.listFazerCardsCatalogFamilies);
router.get('/providers/fazercards/catalog/summary', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.getFazerCardsCatalogSummary);
router.get('/providers/fazercards/contracts/summary', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.getFazerCardsContractsSummary);
router.get('/providers/fazercards/contracts', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.listFazerCardsContracts);
router.get('/providers/fazercards/contracts/:familyKey', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.getFazerCardsContract);
router.post('/providers/fazercards/catalog/backfill-families', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.backfillFazerCardsCatalogFamilies);
...
router.post('/providers/fazercards/catalog/sync-jobs', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsCatalogJobStart), providersCtrl.startFazerCardsCatalogSyncJobs);
router.get('/providers/fazercards/catalog/sync-jobs', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.getFazerCardsCatalogSyncJobs);
...
router.get('/providers/fazercards/orders/manual', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateQuery(schemas.fazerCardsManualOrdersQuery), providersCtrl.listFazerCardsManualOrders);
router.get('/providers/fazercards/orders/:orderId/manual', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.getFazerCardsManualOrder);
router.post('/providers/fazercards/orders/:orderId/manual/complete', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsManualComplete), providersCtrl.completeFazerCardsManualOrder);
router.post('/providers/fazercards/orders/:orderId/manual/fail', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsManualFail), providersCtrl.failFazerCardsManualOrder);
router.post('/providers/fazercards/orders/:orderId/manual/note', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsManualNote), providersCtrl.noteFazerCardsManualOrder);
...
router.post('/providers/fazercards/products/bulk-update-launch', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsBulkLaunch), providersCtrl.bulkUpdateFazerCardsLaunch);
router.post('/providers/fazercards/products/publish-eligible', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsPublishEligibleLaunch), providersCtrl.publishEligibleFazerCardsProducts);
router.post('/providers/fazercards/products/:productId/launch', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsProductLaunch), providersCtrl.updateFazerCardsProductLaunch);
...
router.get('/providers/fazercards/provider-products/:id/import-preview', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), providersCtrl.previewFazerCardsProviderProductImport);
router.post('/providers/fazercards/provider-products/:id/import', authorizeRoles('ADMIN'), requirePermission('suppliers.manage'), validateBody(schemas.fazerCardsProviderProductImport), providersCtrl.importFazerCardsProviderProduct);
...
router.post('/providers/:id/xena/challenge', requirePermission('suppliers.manage'), validateBody(schemas.xenaConnectionChallenge), providersCtrl.challengeXenaConnection);
router.post('/providers/:id/xena/reconnect', requirePermission('suppliers.manage'), validateBody(schemas.xenaConnectionChallenge), providersCtrl.reconnectXenaConnection);
router.post('/providers/:id/xena/verify', requirePermission('suppliers.manage'), validateBody(schemas.xenaConnectionVerify), providersCtrl.verifyXenaConnection);
router.get('/providers/:id/xena/status', requirePermission('suppliers.manage'), providersCtrl.getXenaConnectionStatus);
router.post('/providers/:id/xena/balance/refresh', requirePermission('suppliers.manage'), providersCtrl.refreshXenaBalance);
