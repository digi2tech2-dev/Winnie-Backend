...
const ORDER_ACTIONS = Object.freeze({
    ...
    CLIENT_API_CREATED: 'CLIENT_API_ORDER_CREATED',
});
...
const REFERRAL_ACTIONS = Object.freeze({
    ...
    REFERRAL_COMMISSION_PERCENT_UPDATED: 'referral_commission_percent_updated',
    REFERRAL_COMMISSION_PERCENT_RESET_TO_DEFAULT: 'referral_commission_percent_reset_to_default',
    REFERRAL_DEFAULT_COMMISSION_PERCENT_UPDATED: 'referral_default_commission_percent_updated',
...
const ADMIN_ACTIONS = Object.freeze({
    ...
    SUPERVISOR_CREATED: 'ADMIN_CREATED_SUPERVISOR',
    SUPERVISOR_ASSIGNED: 'ADMIN_ASSIGNED_SUPERVISOR',
    SUPERVISOR_PERMISSIONS_UPDATED: 'ADMIN_UPDATED_SUPERVISOR_PERMISSIONS',
    SUPERVISOR_DELETED: 'ADMIN_DELETED_SUPERVISOR',
    SUPERVISOR_REMOVED: 'ADMIN_REMOVED_SUPERVISOR',
    SUPERVISOR_RESTORED: 'ADMIN_RESTORED_SUPERVISOR',
    ...
    SECURITY_PIN_UPDATED: 'ADMIN_SECURITY_PIN_UPDATED',
    ...
    FINANCIAL_REPORT_DOWNLOADED: 'ADMIN_FINANCIAL_REPORT_DOWNLOADED',
    FINANCIAL_DAY_CLOSED: 'ADMIN_FINANCIAL_DAY_CLOSED',
    WHATSAPP_CUSTOMER_SETTINGS_UPDATED: 'WHATSAPP_CUSTOMER_SETTINGS_UPDATED',
    WHATSAPP_VERIFICATION_CODE_SENT: 'WHATSAPP_VERIFICATION_CODE_SENT',
    WHATSAPP_PHONE_VERIFIED: 'WHATSAPP_PHONE_VERIFIED',
    WHATSAPP_ADMIN_RECIPIENT_CREATED: 'WHATSAPP_ADMIN_RECIPIENT_CREATED',
    WHATSAPP_ADMIN_RECIPIENT_UPDATED: 'WHATSAPP_ADMIN_RECIPIENT_UPDATED',
    WHATSAPP_ADMIN_RECIPIENT_DELETED: 'WHATSAPP_ADMIN_RECIPIENT_DELETED',
    WHATSAPP_TEST_MESSAGE_SENT: 'WHATSAPP_TEST_MESSAGE_SENT',
    WHATSAPP_NOTIFICATION_RETRIED: 'WHATSAPP_NOTIFICATION_RETRIED',
